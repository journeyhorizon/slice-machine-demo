...
const countryCodes: Array<countryCode> = [
  ...
  },
  {
    ...
    es: 'Georgia del Sur e Islas Sandwich deSur',
  ...
  },
  {
    ...
    es: 'Islas Vírgenes de los Estados Unidos de América',
...
const getCountryCodes = <key extends keyof countryCode>(lang: key) => {
  ...
  const codes = countryCodes.map((c: countryCode) => {
